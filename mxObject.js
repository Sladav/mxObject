(function(root, factory) {
  ...
  */
  const mxObject = function(init = {}) {
    ...
    let prototype = Object.getPrototypeOf(init)
      ...
      get(obj, prop) {
        switch (true) {                     // Search order when getting props
          ...
          default:
            ...
            if(prop in mxObject.prototype){     // 5. check if getting utility method/data-prop
              return mxObject.prototype[prop]
            }
            return prototype[prop]              // 6. check the init prototype and the Object/Array/Function prototype
        }
      },
      set(obj, prop, value) {
        switch (true) {
